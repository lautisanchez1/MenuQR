...
#   VITE_API_URL=https://api.example.com bash scripts/deploy-frontends.sh  # override API
#   SKIP_INSTALL=1 bash scripts/deploy-frontends.sh
set -euo pipefail
...
# Sin barra final (Vite/clientes concatenan rutas)
API_URL="${API_URL%/}"
MENU_URL="${MENU_URL%/}"
